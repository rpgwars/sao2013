...
public class DominationTest {
	...
	public void before(){
		...
		ss2.getSolutions().get(0).setDecisionVector(new double[] { 0.0 });
		ss2.getSolutions().get(1).setDecisionVector(new double[] { 0.1 });
		ss2.getSolutions().get(2).setDecisionVector(new double[] { 0.2 });
		ss2.getSolutions().get(3).setDecisionVector(new double[] { 0.3 });
		ss2.getSolutions().get(4).setDecisionVector(new double[] { 0.4 });
		ss2.getSolutions().get(5).setDecisionVector(new double[] { 0.5 });
		ss2.getSolutions().get(6).setDecisionVector(new double[] { 0.6 });
		ss2.getSolutions().get(7).setDecisionVector(new double[] { 0.7 });
		ss2.getSolutions().get(8).setDecisionVector(new double[] { 0.8 });
		ss2.getSolutions().get(9).setDecisionVector(new double[] { 0.9 });
	...
	public void testDominatedMax(){
		...
		assertEquals(ss.getSolutions().get(0).getDecisionVector()[0], 0.9,0.00001);
	...
	public void testDominatedMin(){
		...
		assertEquals(ss2.getSolutions().get(0).getDecisionVector()[0], 0.0,0.00001);
